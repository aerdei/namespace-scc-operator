...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner NamespaceSCC
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &namespacesccv1alpha1.NamespaceSCC{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileNamespaceSCC) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the NamespaceSCC instance
	instance := &namespacesccv1alpha1.NamespaceSCC{}
	...
	// Set NamespaceSCC instance as the owner and controller
...
func newPodForCR(cr *namespacesccv1alpha1.NamespaceSCC) *corev1.Pod {
